            ...
            <div class="search-table-w">
              <div class="search-term">
                ...
                <el-date-picker v-if="isAuth('query')" v-model="beginCreateTime" type="daterange" range-separator="至"
                  value-format="yyyy-MM-dd" start-placeholder="创建开始日期" end-placeholder="创建结束日期" size="medium">
                </el-date-picker>
                <el-date-picker v-if="isAuth('query')" v-model="endCreateTime" type="daterange" range-separator="至"
                  value-format="yyyy-MM-dd" start-placeholder="更新开始日期" end-placeholder="更新结束日期" size="medium">
                </el-date-picker>
