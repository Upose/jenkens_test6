  ...
  <div class="admin-warp-page">
    <el-container>
      ...
      <el-main class="admin-content pd admin-bg-top" :class="{'content-collapse':$root.collapse}">
        <breadcrumb :cuMenu="'栏目管理'" :fontColor="'fff'" ref="breadcrumb_ref"></breadcrumb>
        <!--面包屑导航--->
...
export default {
  ...
  methods: {
    ...
    initData() {
      this.tableData = [];
      this.http.getPlain_url('content-process-log-get',
        '/' + this.c_id + "?contentid=" + this.id + "&pageIndex=" + this.pageData.pageIndex + "&pageSize=" + this.pageData.pageSize
      ).then(res => {
