      ...
      <el-main class="admin-content pd admin-bg-top" :class="{ 'content-collapse': $root.collapse }">
        ...
        <div class="content">
          ...
          <step_one v-show="cuStep == 1" @nextStep="nextStep" ref="step_one_ref" :dataDetails="details_ob"
            :is_edit="id ? true : false"></step_one>
          <step_two v-show="cuStep==2" @nextStep="nextStep" ref="step_two_ref" :dataDetails="details_ob"
            :is_edit="id ? true : false"></step_two>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      this.$refs.step_two_ref.changeLoading(true);
      if (this.id) {
